...
class AddBookPage extends StatefulWidget {
  ...
  @override State<AddBookPage> createState() => _AddBookPageState();
}
...
class _AddBookPageState extends State<AddBookPage> {
  ...
  void _submitBook() async {
    ...
    t.clear(); a.clear(); d.clear();
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Book Added to Inventory!")));
  }
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        const Text("Register New Book", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
        ...
        DropdownButtonFormField<String>(
          ...
          items: ["General", "Fiction", "Science", "History", "Biography", "Tech"]
        ...
        loading ? const CircularProgressIndicator() : SizedBox(
          ...
          height: 50,
          child: ElevatedButton(onPressed: _submitBook, child: const Text("SAVE BOOK")),
        ),
      ]),
    );
  }
